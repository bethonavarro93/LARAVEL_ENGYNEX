        ...
        <figure class="position-absolute start-0 bottom-0 mb-6 ms-5 d-none d-lg-block">
            <svg width="180" height="145" viewbox="0 0 410 330" xmlns="http://www.w3.org/2000/svg">
                <ellipse class="fill-primary" transform="matrix(.7071 -.7071 .7071 .7071 -60.058 144.88)" cx="144.86"
                    cy="144.94" rx="142.86" ry="142.86"></ellipse>
                <defs>
                    <circle id="round-bg-2" cx="279.27" cy="200.22" r="128.73"></circle>
                </defs>
                <clippath id="dots">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <h2 class="mb-4 display-6">{{ __('Nuestros') }} <span class="text-dark-stroke">{{ __('servicios')
                            }}</span></h2>

                    <p class="lead display-8">
                        {{ __('__Tenemos todas las soliciones tecnologicas que tu negocio necesita') }}
                    </p>

                    <p class="lead" style="text-align: justify;">
                        {{ __('Todos nuestros servicios y productos son de alta calidad y con un excelente servicio al
                        cliente.') }}
                    </p>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-6">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-image">
                            <!-- Card image -->
                            <img class="w-100" style="height: 230px;" src="{{ asset('images/banner/diseno-web.jpg') }}"
                                alt="card image">
                            <!-- Card image popup -->
                        </div>
                        <!-- Card body -->
                        <div class="card-body bg-dark p-3 p-md-4 p-xl-5">
                            <div class="mt-auto card-text">
                                <h4 class="text-white">{{ __('Desarrollo web') }}</h4>
                                <p class="text-white mb-3 text-justify">
                                    {{ __('Obtenga un sitio web de calidad, con un diseño moderno y atractivo, que le
                                    permita llegar a más clientes y aumentar sus ventas.') }}
                                </p>
                                <a href="portfolio-detail-1.html" class="btn btn-primary btn-line">
                                    {{ __('Ver más') }}
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 mb-6">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-image">
                            <!-- Card image -->
                            <img class="w-100" style="height: 230px;" src="{{ asset('images/banner/tienda.jpg') }}"
                                alt="card image">
                            <!-- Card image popup -->
                        </div>
                        <!-- Card body -->
                        <div class="card-body bg-dark p-3 p-md-4 p-xl-5">
                            <div class="mt-auto card-text">
                                <h4 class="text-white">{{ __('Tienda virtual') }}</h4>
                                <p class="text-white mb-3 text-justify">
                                    {{ __('Tu tienda virtual es la mejor forma de vender tus productos o servicios en
                                    línea que te permite llegar a más clientes y
                                    aumentar sus ventas.') }}
                                </p>
                                <a href="portfolio-detail-1.html" class="btn btn-primary btn-line">
                                    {{ __('Ver más') }}
                ...
                <div class="col-md-6 col-lg-4 mb-6">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-image">
                            <!-- Card image -->
                            <img class="w-100" style="height: 230px;" src="{{ asset('images/banner/plataformas.jpg') }}"
                                alt="card image">
                            <!-- Card image popup -->
                        </div>
                        <!-- Card body -->
                        <div class="card-body bg-dark p-3 p-md-4 p-xl-5">
                            <div class="mt-auto card-text">
                                <h4 class="text-white">{{ __('Plataformas web') }}</h4>
                                <p class="text-white mb-3 text-justify">
                                    {{ __('Desarrollamos plataformas web para que puedas gestionar tu negocio de forma
                                    fácil y rápida, con un diseño moderno y atractivo.') }}
                                </p>
                                <a href="portfolio-detail-1.html" class="btn btn-primary btn-line">
                                    {{ __('Ver más') }}
                                </a>
                ...
                <div class="col-md-6 col-lg-4 mb-6">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-image">
                            <!-- Card image -->
                            <img class="w-100" style="height: 230px;"
                                src="{{ asset('images/banner/e-learning-1.jpg') }}" alt="card image">
                            <!-- Card image popup -->
                        </div>
                        <!-- Card body -->
                        <div class="card-body bg-dark p-3 p-md-4 p-xl-5">
                            <div class="mt-auto card-text">
                                <h4 class="text-white">{{ __('Soluciones de E-learning') }}</h4>
                                <p class="text-white mb-3 text-justify">
                                    {{ __('Plataforma de E-learning para que puedas gestionar tus cursos de forma fácil
                                    y rápida, con un diseño moderno y atractivo.') }}
                                </p>
                                <a href="portfolio-detail-1.html" class="btn btn-primary btn-line">
                                    {{ __('Ver más') }}
                                </a>
                ...
                <div class="col-md-6 col-lg-4 mb-6">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-image">
                            <!-- Card image -->
                            <img class="w-100" style="height: 230px;" src="{{ asset('images/banner/Intranet.png') }}"
                                alt="card image">
                            <!-- Card image popup -->
                        </div>
                        <!-- Card body -->
                        <div class="card-body bg-dark p-3 p-md-4 p-xl-5">
                            <div class="mt-auto card-text">
                                <h4 class="text-white">{{ __('Intranet corporativa') }}</h4>
                                <p class="text-white mb-3 text-justify">
                                    {{ __('Has pensado en tener una intranet corporativa para tu empresa, pero no sabes
                                    por dónde empezar? Nosotros te ayudamos a crearla.') }}
                                </p>
                                <a href="portfolio-detail-1.html" class="btn btn-primary btn-line">
                                    {{ __('Ver más') }}
                                </a>
                ...
                <div class="col-md-6 col-lg-4 mb-6">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-image">
                            <!-- Card image -->
                            <img class="w-100" style="height: 230px;" src="{{ asset('images/banner/marketing.png') }}"
                                alt="card image">
                            <!-- Card image popup -->
                        </div>
                        <!-- Card body -->
                        <div class="card-body bg-dark p-3 p-md-4 p-xl-5">
                            <div class="mt-auto card-text">
                                <h4 class="text-white">{{ __('Marketing digital') }}</h4>
                                <p class="text-white mb-3 text-justify">
                                    {{ __('El marketing digital es una de las mejores formas de promocionar tu negocio
                                    en internet, nosotros te ayudamos a crear tu estrategia.') }}
                                </p>
                                <a href="portfolio-detail-1.html" class="btn btn-primary btn-line">
                                    {{ __('Ver más') }}
                                </a>
                ...
                <div class="col-md-6 col-lg-4 mb-6">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-image">
                            <!-- Card image -->
                            <img class="w-100" style="height: 230px;"
                                src="{{ asset('images/banner/produccion-audiovisual.png') }}" alt="card image">
                            <!-- Card image popup -->
                        </div>
                        <!-- Card body -->
                        <div class="card-body bg-dark p-3 p-md-4 p-xl-5">
                            <div class="mt-auto card-text">
                                <h4 class="text-white">{{ __('Producción audiovisual') }}</h4>
                                <p class="text-white mb-3 text-justify">
                                    {{ __('Contamos con el mejor equipo audiovisual capaz de crear el contenido adecuado
                                    para
                                    promocionar tu negocio y/o productos en internet.') }}
                                </p>
                                <a href="portfolio-detail-1.html" class="btn btn-primary btn-line">
                                    {{ __('Ver más') }}
                                </a>
                ...
                <div class="col-md-6 col-lg-4 mb-6">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-image">
                            <!-- Card image -->
                            <img class="w-100" style="height: 230px;" src="{{ asset('images/banner/cctv.png') }}"
                                alt="card image">
                            <!-- Card image popup -->
                        </div>
                        <!-- Card body -->
                        <div class="card-body bg-dark p-3 p-md-4 p-xl-5">
                            <div class="mt-auto card-text">
                                <h4 class="text-white">{{ __('Sistema de seguridad (CCTV)') }}</h4>
                                <p class="text-white mb-3 text-justify">
                                    {{ __('Contamos con el mejor equipo de seguridad para proteger tu negocio, con
                                    cámaras
                                    de
                                    alta definición y grabación en la nube.') }}
                                </p>
                                <a href="portfolio-detail-1.html" class="btn btn-primary btn-line">
                                    {{ __('Ver más') }}
                                </a>
                ...
                {{-- <div class="col-md-6 col-lg-4 mb-6">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-body bg-dark p-3 p-md-4 p-xl-5">
                            <div class="mt-auto card-text">
                                <h4 class="text-white">{{ __('Telefonia VoIP') }}</h4>
                                <p class="text-white mb-3 text-justify">
                                    Troncales VoIP, telefonía IP, telefonía IP PBX, telefonía IP para empresas
                                </p>
                                <a href="portfolio-detail-1.html" class="btn btn-primary btn-line">
                                    {{ __('Ver más') }}
                                </a>
